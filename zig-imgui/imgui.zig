    ...
    return extern struct {
        ...
        pub fn clone(self: @This()) @This() {
            ...
            if (self.Size != 0) {
                ...
                @memcpy(cloned.Data.?, @as([*]const u8, @ptrCast(self.Data.?)));
            }
            return cloned;
        }
        ...
        pub fn copy(self: *@This(), other: @This()) void {
            ...
            if (other.Size != 0) {
                ...
                @memcpy(self.Data.?, @as([*]const u8, @ptrCast(other.Data.?)));
            }
        }
        ...
        pub fn from_slice(slice: []const T) @This() {
            ...
            if (slice.len != 0) {
                ...
                @memcpy(result.Data.?, @as([*]const u8, @ptrCast(slice.ptr)));
            }
            return result;
        }
        ...
        pub fn reserve(self: *@This(), new_capacity: u32) void {
            ...
            const new_data = @as(?[*]T, @ptrCast(@alignCast(raw.igMemAlloc(new_capacity * @sizeOf(T)))));
            if (self.Data) |sd| {
                if (self.Size != 0) {
                    @memcpy(new_data.?, @as([*]const u8, @ptrCast(sd)));
                }
        ...
        pub fn reserve_discard(self: *@This(), new_capacity: u32) void {
            ...
            self.Data = @as(?[*]T, @ptrCast(@alignCast(raw.igMemAlloc(new_capacity * @sizeOf(T)))));
            self.Capacity = new_capacity;
        }
...
pub const DrawCornerFlags = packed struct {
    ...
    pub const None: @This() = .{};
    pub const Top: @This() = .{ .TopLeft = true, .TopRight = true };
    pub const Bot: @This() = .{ .BotLeft = true, .BotRight = true };
    pub const Left: @This() = .{ .TopLeft = true, .BotLeft = true };
    pub const Right: @This() = .{ .TopRight = true, .BotRight = true };
    pub const All: @This() = .{ .TopLeft = true, .TopRight = true, .BotLeft = true, .BotRight = true };
...
pub const ColorEditFlags = packed struct {
    ...
    pub const None: @This() = .{};
    pub const _OptionsDefault: @This() = .{ .DisplayRGB = true, .Uint8 = true, .PickerHueBar = true, .InputRGB = true };
    pub const _DisplayMask: @This() = .{ .DisplayRGB = true, .DisplayHSV = true, .DisplayHex = true };
    pub const _DataTypeMask: @This() = .{ .Uint8 = true, .Float = true };
    pub const _PickerMask: @This() = .{ .PickerHueBar = true, .PickerHueWheel = true };
    pub const _InputMask: @This() = .{ .InputRGB = true, .InputHSV = true };
...
pub const DrawList = extern struct {
    ...
    pub inline fn AddImageRounded(self: *DrawList, user_texture_id: TextureID, p_min: Vec2, p_max: Vec2, uv_min: Vec2, uv_max: Vec2, col: u32, rounding: f32) void {
        return @This().AddImageRoundedExt(self, user_texture_id, p_min, p_max, uv_min, uv_max, col, rounding, DrawCornerFlags.All);
    }
    ...
    pub inline fn AddRect(self: *DrawList, p_min: Vec2, p_max: Vec2, col: u32) void {
        return @This().AddRectExt(self, p_min, p_max, col, 0.0, DrawCornerFlags.All, 1.0);
    }
    ...
    pub inline fn AddRectFilled(self: *DrawList, p_min: Vec2, p_max: Vec2, col: u32) void {
        return @This().AddRectFilledExt(self, p_min, p_max, col, 0.0, DrawCornerFlags.All);
    }
    ...
    pub inline fn PathArcTo(self: *DrawList, center: Vec2, radius: f32, a_min: f32, a_max: f32) void {
        return @This().PathArcToExt(self, center, radius, a_min, a_max, 10);
    }
    ...
    pub inline fn PathRect(self: *DrawList, rect_min: Vec2, rect_max: Vec2) void {
        return @This().PathRectExt(self, rect_min, rect_max, 0.0, DrawCornerFlags.All);
    }
    ...
    pub inline fn PathStroke(self: *DrawList, col: u32, closed: bool) void {
        return @This().PathStrokeExt(self, col, closed, 1.0);
    }
...
pub inline fn CaptureKeyboardFromApp() void {
    return @This().CaptureKeyboardFromAppExt(true);
}
...
pub inline fn CaptureMouseFromApp() void {
    return @This().CaptureMouseFromAppExt(true);
}
...
pub inline fn DragScalar(label: ?[*:0]const u8, data_type: DataType, p_data: ?*anyopaque, v_speed: f32) bool {
    return @This().DragScalarExt(label, data_type, p_data, v_speed, null, null, null, .{});
}
...
pub inline fn DragScalarN(label: ?[*:0]const u8, data_type: DataType, p_data: ?*anyopaque, components: i32, v_speed: f32) bool {
    return @This().DragScalarNExt(label, data_type, p_data, components, v_speed, null, null, null, .{});
}
...
pub inline fn IsKeyPressed(user_key_index: i32) bool {
    return @This().IsKeyPressedExt(user_key_index, true);
}
...
pub inline fn ListBoxHeader_Vec2Ext(label: ?[*:0]const u8, size: Vec2) bool {
    return raw.igListBoxHeader_Vec2(label, &size);
}
pub inline fn ListBoxHeader_Vec2(label: ?[*:0]const u8) bool {
    return @This().ListBoxHeader_Vec2Ext(label, .{ .x = 0, .y = 0 });
}

/// ListBoxHeader_IntExt(label: ?[*:0]const u8, items_count: i32, height_in_items: i32) bool
pub const ListBoxHeader_IntExt = raw.igListBoxHeader_Int;
pub inline fn ListBoxHeader_Int(label: ?[*:0]const u8, items_count: i32) bool {
    return @This().ListBoxHeader_IntExt(label, items_count, -1);
}
...
pub inline fn OpenPopupExt(str_id: ?[*:0]const u8, popup_flags: PopupFlags) void {
    return raw.igOpenPopup(str_id, popup_flags.toInt());
}
pub inline fn OpenPopup(str_id: ?[*:0]const u8) void {
    return @This().OpenPopupExt(str_id, .{});
}
...
/// SetAllocatorFunctionsExt(alloc_func: ?fn (sz: usize, user_data: ?*anyopaque) callconv(.C) ?*anyopaque, free_func: ?fn (ptr: ?*anyopaque, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque) void
pub const SetAllocatorFunctionsExt = raw.igSetAllocatorFunctions;
pub inline fn SetAllocatorFunctions(alloc_func: *const fn (sz: usize, user_data: ?*anyopaque) callconv(.C) ?*anyopaque, free_func: *const fn (ptr: ?*anyopaque, user_data: ?*anyopaque) callconv(.C) void) void {
...
pub inline fn TableSetupColumnExt(label: ?[*:0]const u8, flags: TableColumnFlags, init_width_or_weight: f32, user_id: u32) void {
...
pub const raw = struct {
    ...
    pub extern fn ImDrawList_AddImageRounded(self: *DrawList, user_texture_id: TextureID, p_min: *const Vec2, p_max: *const Vec2, uv_min: *const Vec2, uv_max: *const Vec2, col: u32, rounding: f32, rounding_corners: DrawCornerFlagsInt) callconv(.C) void;
    ...
    pub extern fn ImDrawList_AddRect(self: *DrawList, p_min: *const Vec2, p_max: *const Vec2, col: u32, rounding: f32, rounding_corners: DrawCornerFlagsInt, thickness: f32) callconv(.C) void;
    pub extern fn ImDrawList_AddRectFilled(self: *DrawList, p_min: *const Vec2, p_max: *const Vec2, col: u32, rounding: f32, rounding_corners: DrawCornerFlagsInt) callconv(.C) void;
    ...
    pub extern fn ImDrawList_PathRect(self: *DrawList, rect_min: *const Vec2, rect_max: *const Vec2, rounding: f32, rounding_corners: DrawCornerFlagsInt) callconv(.C) void;
    ...
    pub extern fn igListBoxHeader_Vec2(label: ?[*:0]const u8, size: *const Vec2) callconv(.C) bool;
    pub extern fn igListBoxHeader_Int(label: ?[*:0]const u8, items_count: i32, height_in_items: i32) callconv(.C) bool;
    ...
    pub extern fn igOpenPopup(str_id: ?[*:0]const u8, popup_flags: PopupFlagsInt) callconv(.C) void;
    ...
    pub extern fn igSetAllocatorFunctions(alloc_func: *const fn (sz: usize, user_data: ?*anyopaque) callconv(.C) ?*anyopaque, free_func: *const fn (ptr: ?*anyopaque, user_data: ?*anyopaque) callconv(.C) void, user_data: ?*anyopaque) callconv(.C) void;
    ...
    pub extern fn igTableSetupColumn(label: ?[*:0]const u8, flags: TableColumnFlagsInt, init_width_or_weight: f32, user_id: u32) callconv(.C) void;
